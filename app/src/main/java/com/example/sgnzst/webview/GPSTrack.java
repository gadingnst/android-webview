...
public class GPSTrack extends Service implements LocationListener {
     ...
     * On pressing Statics button will lauch Statics Options
     * */
    public void showSettingsAlert(){
        ...
        // On pressing Statics button
        alertDialog.setPositiveButton("Statics", new DialogInterface.OnClickListener() {
